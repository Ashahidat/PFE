...
def get_allowed_classifications(
    ...
    """
    # Récupérer la classification du dataset
    ...
    if not dataset_class:
        return {
            ...
            "message": "Le dataset n'a pas de classification active"
        }
    ...
    return {
        ...
        "message": "AUCUNE colonne classifiée autorisée" if dataset_classification == "PUBLIC" else None
    }
