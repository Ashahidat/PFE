...
def create_dataset(
    ...
    La signature est utilisée pour les calculs internes
    mais n'est PAS envoyée à Atlas.
    ...
    # ---------------------------------------------------------------------
    # 1) Création du dataset SANS la signature dans Atlas
    # ---------------------------------------------------------------------
    ...
    payload = {
        "entities": [{
            ...
            "attributes": {
                ...
                # ❌ SIGNATURE SUPPRIMÉE — plus envoyée à Atlas
